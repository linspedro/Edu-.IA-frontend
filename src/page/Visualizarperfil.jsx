          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-blue-100 rounded-2xl p-6">
                ...
                <p className="font-semibold mt-4">Total de Planos</p>
                <span className="text-sm text-gray-500">Criados até agora</span>
              </div>

              <div className="bg-purple-100 rounded-2xl p-6">
                <h3 className="text-5xl font-bold text-purple-700">2</h3>
                <p className="font-semibold mt-4">Planos Manuais</p>
              ...
              <div className="bg-yellow-100 rounded-2xl p-6">
                ...
                <p className="font-semibold mt-4">Planos com IA</p>
                <span className="text-sm text-gray-500">Gerados por IA</span>
              </div>
            </div>
          </div>
        </main>
